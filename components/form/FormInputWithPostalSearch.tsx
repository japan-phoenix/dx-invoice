                        ...
                        <>
                            <div className="relative flex w-full items-center">
                                <input
                                    ...
                                    disabled={disabled}
                                    className={`w-full rounded border px-3 py-2 pl-10 text-base focus:outline-none ${displayError ? 'border-red-500' : 'border-gray-300'} ${disabled ? 'cursor-not-allowed bg-gray-100 opacity-60' : ''}`}
                                />
                                <button
                                    type="button"
                            ...
                            />
                            {displayError && <div className="mt-1 text-sm text-red-600">{displayError}</div>}
                        </>
                    )
                }}
            />
