...
('御供養(減算)', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
((SELECT id FROM public.product_items WHERE name = '御供養(減算)'), '基本型', NULL, -25000, -15000, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
((SELECT id FROM public.product_items WHERE name = '御供養(減算)'), '上級型', NULL, -50000, -30000, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
