...
export default function FlowerPdfPage() {
    ...
    const loadData = async () => {
        try {
            const [flowersData, companyData] = await Promise.all([getFlowers(customerId), getCompanyProfile()])
                    ...
                    return (
                        ...
                        >
                            ...
                            <div style={{ marginBottom: '2rem' }}>
                                <p>
                                    <strong>請求先:</strong> {target.billToName}
                                </p>
                                <p>
                                    <strong>住所:</strong> {target.billToAddress}
                                </p>
                                {target.billToTel && (
                                    <p>
                                        <strong>TEL:</strong> {target.billToTel}
                                    </p>
                                )}
                            </div>
                            ...
                            >
                                <thead>
                                    <tr style={{ backgroundColor: '#f5f5f5' }}>
                                        ...
                                        <th
                                            style={{ padding: '0.75rem', border: '1px solid #ddd', textAlign: 'right' }}
                                        >
                                            金額
                                        </th>
                                    </tr>
                            ...
                            {company && (
                                ...
                                >
                                    ...
                                    {company.bank1Name && (
                                        <p>
                                            {company.bank1Name} {company.bank1Branch} {company.bank1Type}{' '}
                                            {company.bank1Account} {company.bank1Holder}
                                        </p>
                                    )}
                                </div>
                            )}
