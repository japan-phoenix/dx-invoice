...
('異具小物一式', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
((SELECT id FROM public.product_items WHERE name = '霊柩車'), '基本型', NULL, 25000, 15000, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
((SELECT id FROM public.product_items WHERE name = '霊柩車'), '上級型', NULL, 50000, 30000, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
((SELECT id FROM public.product_items WHERE name = '異具小物一式'), '基本型', NULL, 25000, 15000, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
((SELECT id FROM public.product_items WHERE name = '異具小物一式'), '上級型', NULL, 50000, 30000, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
