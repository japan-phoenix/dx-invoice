...
export default function CasesPage() {
    ...
    const loadInitialData = async () => {
        try {
            const [customersData, citiesData] = await Promise.all([searchCustomers({}), getCities()])
        ...
        <div style={{ padding: '2rem' }}>
            ...
            >
                ...
                >
                    ...
                    <div>
                        <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.875rem' }}>町字</label>
                        <select
                            value={searchParams.townId || ''}
                            onChange={(e) => setSearchParams({ ...searchParams, townId: e.target.value })}
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => setSearchParams({ ...searchParams, receptionFrom: e.target.value })}
                            style={{
                                width: '100%',
                                padding: '0.5rem',
                                border: '1px solid #ddd',
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => setSearchParams({ ...searchParams, receptionTo: e.target.value })}
                            style={{
                                width: '100%',
                                padding: '0.5rem',
                                border: '1px solid #ddd',
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => setSearchParams({ ...searchParams, funeralFrom: e.target.value })}
                            style={{
                                width: '100%',
                                padding: '0.5rem',
                                border: '1px solid #ddd',
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => setSearchParams({ ...searchParams, funeralTo: e.target.value })}
                            style={{
                                width: '100%',
                                padding: '0.5rem',
                                border: '1px solid #ddd',
                ...
                >
                    <thead>
                        <tr style={{ backgroundColor: '#f5f5f5' }}>
                            <th style={{ padding: '0.75rem', border: '1px solid #ddd', textAlign: 'left' }}>氏名</th>
                            <th style={{ padding: '0.75rem', border: '1px solid #ddd', textAlign: 'left' }}>行年</th>
                            <th style={{ padding: '0.75rem', border: '1px solid #ddd', textAlign: 'left' }}>住所</th>
                            <th style={{ padding: '0.75rem', border: '1px solid #ddd', textAlign: 'left' }}>受付日</th>
                            <th style={{ padding: '0.75rem', border: '1px solid #ddd', textAlign: 'left' }}>葬儀日</th>
                            <th style={{ padding: '0.75rem', border: '1px solid #ddd', textAlign: 'center' }}>見積</th>
                            <th style={{ padding: '0.75rem', border: '1px solid #ddd', textAlign: 'center' }}>請求</th>
                            <th style={{ padding: '0.75rem', border: '1px solid #ddd', textAlign: 'center' }}>入金</th>
            ...
            {paymentDialog.open && (
                ...
                >
                    <div
                        ...
                        onClick={(e) => e.stopPropagation()}
                    >
                        <h2 style={{ marginBottom: '1.5rem' }}>{paymentDialog.isPaid ? '入金取消' : '入金登録'}</h2>
